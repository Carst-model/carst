...
_WANTED_FILES = {
    "land":
    lambda solver: tuple((solver.land, )),
    "layer_data":
    lambda solver: tuple((solver.funcs[carst_funcs.diff_coeff], solver.funcs[
    ...
    "sea_level":
    lambda solver: tuple((solver.funcs[carst_funcs.sea_level], )),
}
...
class OutputFilesCollection:
    ...
    def __init__(self, output_folder, enabled_processes):
        ...
        self._out_files = {
            file_name: fd.File(f"{full_path}/{file_name}.pvd")
